...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    lda #$1E
    sta COLUPF                ; reset TIA registers before displaying the score
...
CheckP0Up:
    ...
    inc JetYPos
    lda #0
    sta JetAnimOffset          ;     then: skip to test next input option
      ;         set jet frame of animation to first one
...
CheckP0Right:
    ...
    bne CheckButtonPresses
    lda JetXPos
    cmp #100
    bpl CheckButtonPresses
    inc JetXPos
